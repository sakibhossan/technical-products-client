...
const ProductDetail = () => {
    ...
    return (
            ...
            <form className=' w-72 lg:w-96   mx-auto  mt-4' onSubmit={handleSubmit(onSubmit)}>
                ...
                <input className= 'w-72 lg:w-96  mt-2   rounded ring ring-lime-500' src={img} style={{ border: '2px solid red' }} type="image" alt='' {...register("image")} />
                ...
                <input className='w-32 mx-24 mt-2 px-10  text-lg text-blue-500 rounded ring ring-green-500' value={price} style={{ border: '2px solid red' }} {...register("lastName")} />
